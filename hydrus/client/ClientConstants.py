...
animated_webp_support = ( animated_webp_media_actions, True, True )
animated_jxl_support = ( animated_jxl_media_actions, True, True )
...
for mime in HC.SEARCHABLE_MIMES:
    ...
    if mime == HC.ANIMATION_WEBP:
        ...
        media_viewer_capabilities[ mime ] = animated_webp_support
        
    elif mime == HC.ANIMATION_JXL:
        
        media_viewer_capabilities[ mime ] = animated_jxl_support
...
MEDIA_VIEWER_TAGS_SCROLLING_BEHAVIOUR_NEVER_PROPAGATE = 0
MEDIA_VIEWER_TAGS_SCROLLING_BEHAVIOUR_ONLY_PROPAGATE_ON_NO_SCROLLBAR = 1
MEDIA_VIEWER_TAGS_SCROLLING_BEHAVIOUR_ONLY_PROPAGATE_AFTER_DELAY = 2
MEDIA_VIEWER_TAGS_SCROLLING_BEHAVIOUR_QT_DEFAULT = 3

media_viewer_tags_scrolling_behaviour_str_lookup = {
    MEDIA_VIEWER_TAGS_SCROLLING_BEHAVIOUR_NEVER_PROPAGATE : 'never propagate',
    MEDIA_VIEWER_TAGS_SCROLLING_BEHAVIOUR_ONLY_PROPAGATE_ON_NO_SCROLLBAR : 'only propagate when list has no vertical scrollbar',
    MEDIA_VIEWER_TAGS_SCROLLING_BEHAVIOUR_ONLY_PROPAGATE_AFTER_DELAY : 'only propagate if vertical scrollbar has not been used recently',
    MEDIA_VIEWER_TAGS_SCROLLING_BEHAVIOUR_QT_DEFAULT : 'propagate immediately after vertical scrollbar hits an end (Qt default)',
}
...
class GlobalIcons( object ):
    ...
    def _Reinitialise( self ):
        ...
        self.eye_closed = self._GetSVGOrPNGPathIcon( 'eye_closed' )
