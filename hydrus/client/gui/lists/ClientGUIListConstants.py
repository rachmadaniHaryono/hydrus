...
register_column_type( COLUMN_LIST_DB_MIGRATION_LOCATIONS.ID, COLUMN_LIST_DB_MIGRATION_LOCATIONS.PORTABLE, 'beneath db dir?', False, 12, True )
...
register_column_type( COLUMN_LIST_FILE_MAINTENANCE_JOBS.ID, COLUMN_LIST_FILE_MAINTENANCE_JOBS.NUM_JOBS, 'due jobs', False, 16, True )
...
register_column_type( COLUMN_LIST_SUBSCRIPTION_QUERIES.ID, COLUMN_LIST_SUBSCRIPTION_QUERIES.ADDITIONAL_TAGS, 'additional tags', False, 20, True )
...
register_column_type( COLUMN_LIST_SUBSCRIPTIONS.ID, COLUMN_LIST_SUBSCRIPTIONS.IMPORT_OPTIONS, 'custom import options', False, 24, True )
...
register_column_type( COLUMN_LIST_EDIT_DUPLICATES_AUTO_RESOLUTION_RULES.ID, COLUMN_LIST_EDIT_DUPLICATES_AUTO_RESOLUTION_RULES.OPERATION_MODE, 'operation', False, 18, True )
...
register_column_type( COLUMN_LIST_REVIEW_DUPLICATES_AUTO_RESOLUTION_RULES.ID, COLUMN_LIST_REVIEW_DUPLICATES_AUTO_RESOLUTION_RULES.NAME, 'name', False, 16, True )
register_column_type( COLUMN_LIST_REVIEW_DUPLICATES_AUTO_RESOLUTION_RULES.ID, COLUMN_LIST_REVIEW_DUPLICATES_AUTO_RESOLUTION_RULES.PROGRESS, 'progress', False, 24, True )
...
class COLUMN_LIST_DEFAULT_IMPORT_OPTIONS( COLUMN_LIST_DEFINITION ):
...
column_list_type_name_lookup[ COLUMN_LIST_DEFAULT_IMPORT_OPTIONS.ID ] = 'default import options'

register_column_type( COLUMN_LIST_DEFAULT_IMPORT_OPTIONS.ID, COLUMN_LIST_DEFAULT_IMPORT_OPTIONS.NAME, 'name', False, 30, True )
register_column_type( COLUMN_LIST_DEFAULT_IMPORT_OPTIONS.ID, COLUMN_LIST_DEFAULT_IMPORT_OPTIONS.SUMMARY, 'summary', False, 20, True )

default_column_list_sort_lookup[ COLUMN_LIST_DEFAULT_IMPORT_OPTIONS.ID ] = ( COLUMN_LIST_DEFAULT_IMPORT_OPTIONS.NAME, True )

class COLUMN_LIST_URL_CLASS_IMPORT_OPTIONS( COLUMN_LIST_DEFINITION ):
...
column_list_type_name_lookup[ COLUMN_LIST_URL_CLASS_IMPORT_OPTIONS.ID ] = 'url class default import options'

register_column_type( COLUMN_LIST_URL_CLASS_IMPORT_OPTIONS.ID, COLUMN_LIST_URL_CLASS_IMPORT_OPTIONS.NAME, 'name', False, 40, True )
register_column_type( COLUMN_LIST_URL_CLASS_IMPORT_OPTIONS.ID, COLUMN_LIST_URL_CLASS_IMPORT_OPTIONS.TYPE, 'type', False, 20, True )
register_column_type( COLUMN_LIST_URL_CLASS_IMPORT_OPTIONS.ID, COLUMN_LIST_URL_CLASS_IMPORT_OPTIONS.SUMMARY, 'summary', False, 20, True )

default_column_list_sort_lookup[ COLUMN_LIST_URL_CLASS_IMPORT_OPTIONS.ID ] = ( COLUMN_LIST_URL_CLASS_IMPORT_OPTIONS.NAME, True )
