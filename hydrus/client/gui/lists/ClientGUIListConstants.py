...
class COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_TAG_SERVICES( COLUMN_LIST_DEFINITION ):
...
column_list_type_name_lookup[ COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_TAG_SERVICES.ID ] = 'duplicate action options for tags'

register_column_type( COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_TAG_SERVICES.ID, COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_TAG_SERVICES.SERVICE, 'service', False, 24, True )
register_column_type( COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_TAG_SERVICES.ID, COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_TAG_SERVICES.ACTION, 'action', False, 36, True )
register_column_type( COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_TAG_SERVICES.ID, COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_TAG_SERVICES.TAGS_MERGED, 'tags merged', False, 36, True )

default_column_list_sort_lookup[ COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_TAG_SERVICES.ID ] = ( COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_TAG_SERVICES.SERVICE, True )

#

class COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_RATING_SERVICES( COLUMN_LIST_DEFINITION ):
...
column_list_type_name_lookup[ COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_RATING_SERVICES.ID ] = 'duplicate action options for ratings'

register_column_type( COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_RATING_SERVICES.ID, COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_RATING_SERVICES.SERVICE, 'service', False, 24, True )
register_column_type( COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_RATING_SERVICES.ID, COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_RATING_SERVICES.ACTION, 'action', False, 36, True )

default_column_list_sort_lookup[ COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_RATING_SERVICES.ID ] = ( COLUMN_LIST_DUPLICATE_ACTION_OPTIONS_RATING_SERVICES.SERVICE, True )
